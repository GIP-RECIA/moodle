...
class enrol_simpleldapens_ldapsearch {
    ...
    public function matchLDAPValues($listTmp, $userValues, $i){
    	switch ($i){
    		case 1 : return $this->matchLDAPVAlues1($listTmp,$userValues);
    		case 2 : return $this->matchLDAPVAlues2($listTmp,$userValues);
    		case 3 : return $this->matchLDAPVAlues3($listTmp,$userValues);
    		case 4 : return $this->matchLDAPVAlues4($listTmp,$userValues);
    	}
    	return $listTmp;
    }
    ...
    public function matchLDAPVAlues2($listTmp, $userValues){
    	return $listTmp;
    }
