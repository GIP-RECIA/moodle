...
function xmldb_main_upgrade($oldversion) {
    ...
    // ********************************
    // Ajout de ce bloc provenant de la 3.10 pour gérer correctement le refresh token du oauth de nextcloud
    if ($oldversion < 2020061516.01) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2020061516.01);
    }
    // ********************************
